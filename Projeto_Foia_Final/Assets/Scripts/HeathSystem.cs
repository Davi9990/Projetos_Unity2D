...
public class HealthSystem : MonoBehaviour
{
    ...
    private int revivesMaximo = 2; // Contador de revives
    private int revivesAtual;
    ...
    public void AtualizarTextoRevives()
    {
        textoVidas.text = "" + revivesAtual;
    }
    ...
    public void GanharReviver(int quantidade)
    {
        revivesMaximo += quantidade;
        if (revivesAtual > revivesMaximo)
        {
            revivesAtual = revivesMaximo;
        }
        AtualizarTextoRevives();
    }
    ...
    private void Reviver()
    {
        if (revivesMaximo > 0)
        {
            revivesMaximo--; // Reduzir o contador de revives
