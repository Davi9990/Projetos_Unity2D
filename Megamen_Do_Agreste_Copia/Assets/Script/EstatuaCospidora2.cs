...
public class EstatuaCospidora2 : MonoBehaviour
{
    ...
    void Start()
    {
        // Encontra o objeto alvo na cena com a tag "Circle2"
        target = GameObject.FindGameObjectWithTag("Circle2");
    }
...
public class ProjectileMovement2 : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("Circle2")) // Agora usando "Circle2"
        {
